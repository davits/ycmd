...
BOOST_PYTHON_MODULE(ycm_core)
{
  ...
  enum_< Token::Kind >( "TokenKind" )
    .value( "Punctuation", Token::Kind::PUNCTUATION )
    .value( "Comment", Token::Kind::COMMENT )
    .value( "Keyword", Token::Kind::KEYWORD )
    .value( "Literal", Token::Kind::LITERAL )
    .value( "Identifier", Token::Kind::IDENTIFIER )
    .export_values();

  enum_< Token::Scope >( "TokenScope" )
    .value( "None", Token::Scope::NONE )
    .value( "TranslationUnit", Token::Scope::TRANSLATION_UNIT )
    .value( "Namespace", Token::Scope::NAMESPACE )
    .value( "Class", Token::Scope::CLASS )
    .value( "Struct", Token::Scope::STRUCT )
    .value( "Union", Token::Scope::UNION )
    .value( "Function", Token::Scope::FUNCTION )
    .export_values();

  enum_< Token::Type >( "TokenType" )
    .value( "Punctuation", Token::Type::PUNCTUATION )
    .value( "Comment", Token::Type::COMMENT )
    .value( "Keyword", Token::Type::KEYWORD )
    .value( "Integer", Token::Type::INTEGER )
    .value( "Floating", Token::Type::FLOATING )
    .value( "Imaginary", Token::Type::IMAGINARY )
    .value( "String", Token::Type::STRING )
    .value( "Character", Token::Type::CHARACTER )
    .value( "Namespace", Token::Type::NAMESPACE )
    .value( "Class", Token::Type::CLASS )
    .value( "Struct", Token::Type::STRUCT )
    .value( "Union", Token::Type::UNION )
    .value( "TypeAlias", Token::Type::TYPE_ALIAS )
    .value( "Variable", Token::Type::VARIABLE )
    .value( "Function", Token::Type::FUNCTION )
    .value( "FunctionParameter", Token::Type::FUNCTION_PARAMETER )
    .value( "Enumeration", Token::Type::ENUMERATION )
    .value( "Enumerator", Token::Type::ENUMERATOR )
    .value( "TemplateParameter", Token::Type::TEMPLATE_PARAMETER )
    .value( "TemplateNonTypeParameter",
            Token::Type::TEMPLATE_NON_TYPE_PARAMETER )
    .value( "PreprocessingDirective", Token::Type::PREPROCESSING_DIRECTIVE )
    .value( "Macro", Token::Type::MACRO )
    .value( "Unsupported", Token::Type::UNSUPPORTED )
    .export_values();

  enum_< Token::Modifier >( "TokenModifier" )
    .value( "static", Token::Modifier::STATIC )
    .value( "virtual", Token::Modifier::VIRTUAL )
    .value( "const", Token::Modifier::CONST )
    .value( "mutable", Token::Modifier::MUTABLE )
    .export_values();

  class_< Token >( "Token" )
    .def_readonly( "kind", &Token::kind )
    .def_readonly( "scope", &Token::scope )
    .def_readonly( "type", &Token::type )
    .def_readonly( "range", &Token::range )
    .def_readonly( "modifiers", &Token::modifiers );

  class_< std::vector< Token > >( "TokenVector" )
    .def( vector_indexing_suite< std::vector< Token > >() );

  class_< std::vector< Token::Modifier > >( "TokenModifierVector" )
    .def( vector_indexing_suite< std::vector< Token::Modifier > >() );
